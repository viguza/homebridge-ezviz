...
export class CameraMotionSensor {
  ...
  private triggerMotion(source: MotionSource): void {
    ...
    if (!this.motionDetected) {
      ...
      this.platform.log.info(`${this.displayName}: motion detected${source === 'mqtt' ? ' (MQTT)' : ' (poll)'}`);
    }
  }
